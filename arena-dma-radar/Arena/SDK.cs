namespace SDK
{
	public readonly partial struct ClassNames
	{
		...
		{
			public const uint ClassName_ClassToken = 0x2002256; // MDToken
		...
		{
			public const uint ClassName_ClassToken = 0x2001943; // MDToken
			public const string ClassName = @"\uE877";
		}

		public readonly partial struct GameSettings
		{
			public const uint ClassName_ClassToken = 0x200220F; // MDToken
			public const string ClassName = @"\uEB2A";
		}
		...
		{
			public const uint ClassName_ClassToken = 0x2003C46; // MDToken
			public const string ClassName = @"\uF339";
		}
		...
		{
			public const uint ClassName_ClassToken = 0x2000CA5; // MDToken
			public const uint MethodName_MethodToken = 0x60054D9; // MDToken
	...
	public readonly partial struct Offsets
	{
		...
		public readonly partial struct Player
		{
			...
			public const uint EnabledAnimators = 0xA08; // System.Int32
		}
